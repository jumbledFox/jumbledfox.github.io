...
async function load_levels() {
    ...
    var default_levels = ["GREATEST ARTS.brk", "SPACE.brk", "PRIDEMONTH PACK!.brk", "ANIMAL PACK!.brk", "ANIMALS.brk", "RETRO VIDEOGAMES.brk", "ALBUMS I LIKE.brk", "GAMES.brk", "CHRISTMAS.brk"]
